var icon_img = 'https://jinqili0310.github.io/assets/mercedes/mercedesLogo.png';
var playAd = 0;
var bye = 0;
...
function createQuestions() {
	prescripted_questions[0] = new Question(
		[ 'How are you today?' ],
		[ "I'm doing well.", "I'm okay.", 'I could be better.' ],
		1,
		1
	);
	prescripted_questions[1] = new Question(
		[ 'Okay. How can I be of service?' ],
		[ 'Shop Vehicles', 'Learn About Mercedes-Benz', 'Account Problem', 'Other Inquiries' ],
		2,
		1
	);
	prescripted_questions[2] = new Question(
		[
			'Sounds good. Innovation is our opportunity to change the world. Mercedes-Benz has invented many of the automotive technologies we see today. In 2019, we won the J.D. Power Dependability Award, as well as the J.D. Power Performance Award. At Mercedes-Benz, we deliver the best or nothing.'
		],
		[ '' ],
		3,
		0
	);
	prescripted_questions[3] = new Question(
		[ 'How else can I be of service?' ],
		[ 'Shop Vehicles', 'Learn About Mercedes-Benz', 'Account Problem', 'Other Inquiries' ],
		4,
		0
	);
	prescripted_questions[4] = new Question(
		[
			'You’ve made the right choice – our style and ingenuity are truly unmatched! What are you looking for today?'
		],
		[ 'SUVs', 'Sedans', 'Coupes', 'Convertibles', 'Hybrids' ],
		5,
		4
	);
	prescripted_questions[5] = new Question(
		[
			'I proudly recommend our EQ models, which are fully electric vehicles powered by a Lithium-ion battery. In 2019, these models won the J.D. Power Quality Award. Our EQ models are a beautifully seamless blend of luxury and science. Are you interested in learning more about our EQ models?'
		],
		[ 'Yes', 'No' ],
		6,
		0
	);
	prescripted_questions[6] = new Question(
		[ 'Great. What specifically do you want to know about our unique electric intelligence vehicles?' ],
		[ 'Electricity as Luxury', 'Refined Performance', 'Cutting-Edge Styling' ],
		7,
		1
	);
	prescripted_questions[7] = new Question(
		[
			'Great, that just happens to be my area of expertise. Our electric drive system offers instant power to the wheels with no lag time for the powerful promise of greater acceleration and superior torque. The new 2019 Mercedes-Benz S 560e features a larger battery, a 7.2-kilowatt on-board charger, and more power. That’s why Mercedes-Benz has been a leader of automotive innovations.'
		],
		[ '' ],
		8,
		0
	);
	prescripted_questions[8] = new Question(
		[ 'Select one of the following to learn more:' ],
		[ 'Electircity as Luxury', 'Our Cutting-Edge Styling', 'Explore Other Vehicle Models', 'Additional Options' ],
		9,
		3
	);
	prescripted_questions[9] = new Question(
		[ 'Great. How would you like to proceed?' ],
		[
			'I would like to learn more about your eco-conscious hybrids.',
			'I would like to explore a different model.'
		],
		10,
		0
	);
	prescripted_questions[10] = new Question(
		[ 'Our hybrids offer many unique features. Please select one of the following to proceed:' ],
		[
			'Our Cutting-Edge Styling',
			'A Cross-Country Electric Landscape',
			'In-Home Charging Solutions',
			'Explore Other Vehicle Models'
		],
		11,
		2
	);
	prescripted_questions[11] = new Question(
		[
			'We offer an in-home charging solution because there’s no better place to charge your vehicle than in the comfort of your own home. Our team of highly-trained experts will install a new-generation wallbox right in your home so that you can charge overnight and be ready to hit the road at a moment’s notice. We are confident that you will find this to be a game-changer!'
		],
		[ '' ],
		12,
		0
	);
	prescripted_questions[12] = new Question(
		[ 'What else do you like to know?' ],
		[
			'Shop Our Hybrid Vehicles',
			'Sign-Up for Exclusive Hybrid Communication from Our Team',
			'No more qestions 😊'
		],
		-1,
		2
		...
		if (next_question > -1) {
			...
			setTimeout(function() {
				var outstring =
					...
					user_name +
					'. If you need any more information about award-winning vehicles in the future, I would be more than happy to help. 😊';
				postBotAnswer(outstring);
			}, 2000);
			setTimeout(function() {
				postImage('https://jinqili0310.github.io/assets/mercedes/Mercedes%20Gif%201.gif');
			}, 4000);
		}
	}
}
...
function createButtonQuickReply(options, question_index) {
	...
	options.forEach(function(answer) {
		...
		button.onclick = function() {
			...
			if (
				answer ==
				prescripted_questions[cur_question_index].answers[
					prescripted_questions[cur_question_index].correct_answer_index
				]
			) {
...
function displayBot() {
	...
	if (user_name == '') {
		setTimeout(function() {
			postBotAnswer("Hello, car connoisseur! I am Mercedes-Benz's chatbot powered by artificial intelligence. What is your name?");
		}, 500);
	}
}
